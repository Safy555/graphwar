...
begin
  ...
  setfillstyle(1,darkgray);
  bar(sipky_x-(sipky_sirka div 2)+7,sipky_y+4,sipky_x+(sipky_sirka div 2)+7,sipky_y+sipky_vyska+4);
  ...
  repeat
     ...
     if (lowercase(ch)='s') and (x<nn) then begin    //sipka dole
       setfillstyle(1,lightgray);
       bar(sipky_x-(sipky_sirka div 2)-1,(sipky_y+skok*p)-1,sipky_x+(sipky_sirka div 2)+8,(sipky_y+skok*p)+sipky_vyska+4);
       p:=p+1;
       x:=x+1;
       setfillstyle(1,darkgray);
       bar(sipky_x-(sipky_sirka div 2)+7,(sipky_y+skok*p)+4,sipky_x+(sipky_sirka div 2)+7,(sipky_y+skok*p)+sipky_vyska+4);
       setfillstyle(1,farba_sipky);
...
begin
  ...
  repeat
    ...
    settextstyle(0,0,7);setcolor(darkgray);
    outtextxy((getmaxx div 2)-103,170+(vy div 2)-25,'Hrat');
    outtextxy((getmaxx div 2)-213,170+(vy div 2)+vy-25,'Rebricek');
    outtextxy((getmaxx div 2)-213,170+(vy div 2)+(2*vy)-25,'Napoveda');
    outtextxy((getmaxx div 2)-158,170+(vy div 2)+(3*vy)-25,'Koniec');
    setcolor(green);
    outtextxy((getmaxx div 2)-100,(170+(vy div 2))-29,'Hrat');
    outtextxy((getmaxx div 2)-210,(170+(vy div 2)+vy)-29,'Rebricek');
    outtextxy((getmaxx div 2)-210,(170+(vy div 2)+(2*vy))-29,'Napoveda');
    outtextxy((getmaxx div 2)-155,(170+(vy div 2)+(3*vy))-29,'Koniec');
    case sipky(getmaxx div 2,205,100,7,((getmaxy-250) div 4),4,green) of
    1:begin
           menu(5);
           esc:=0;
           stavhry:=0;
           ...
           settextstyle(0,0,7);setcolor(darkgray);
           outtextxy((getmaxx div 2)-178,170+(vy div 2)-25,'Level 1');
           outtextxy((getmaxx div 2)-178,170+(vy div 2)+vy-25,'Level 2');
           outtextxy((getmaxx div 2)-178,170+(vy div 2)+(2*vy)-25,'Level 3');
           outtextxy((getmaxx div 2)-178,170+(vy div 2)+(3*vy)-25,'Level 4');
           outtextxy((getmaxx div 2)-103,170+(vy div 2)+(4*vy)-25,'Spat');
           setcolor(green);
           outtextxy((getmaxx div 2)-175,(170+(vy div 2))-29,'Level 1');
           outtextxy((getmaxx div 2)-175,(170+(vy div 2)+vy)-29,'Level 2');
           outtextxy((getmaxx div 2)-175,(170+(vy div 2)+(2*vy))-29,'Level 3');
           outtextxy((getmaxx div 2)-175,(170+(vy div 2)+(3*vy))-29,'Level 4');
           outtextxy((getmaxx div 2)-100,(170+(vy div 2)+(4*vy))-29,'Spat');
           case sipky(getmaxx div 2,202,100,7,((getmaxy-250) div 5),5,green) of
           1:begin
                  pole();t:=0;
                  generovanie(1);
                  repeat
